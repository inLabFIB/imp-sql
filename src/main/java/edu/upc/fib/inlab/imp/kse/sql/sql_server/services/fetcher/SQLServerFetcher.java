...
import edu.upc.fib.inlab.imp.kse.sql.core.services.parser.SQLLexer;
...
public class SQLServerFetcher implements DatabaseFetcher {
    ...
    private ValueExpression visitInputExpression(String booleanExpression, String tableName) {
        ...
        SQLParser.ExpressionContext tree = parser.expression();
        SQLExpressionGrammarVisitorImpl visitor = new SQLExpressionGrammarVisitorImpl(tableName);
    ...
    private BooleanExpression visitBooleanExpression(String booleanExpression, String tableName) {
        ...
        SQLParser.Search_conditionContext tree = parser.search_condition();
        SQLExpressionGrammarVisitorImpl visitor = new SQLExpressionGrammarVisitorImpl(tableName);
