/*
  This grammar accepts only the SPJ version of value and boolean expressions that can be accepted in a DEFAULT or CHECK
  constraints. Any increase in supported expressions in the Parser grammar must also be added to this one.
*/

parser grammar TSqlExpressionParser;

options { tokenVocab=TSqlLexer; }

expression
    : default_expression EOF
...
predicate
    : check_value_expression comparison_operator check_value_expression
    ;
